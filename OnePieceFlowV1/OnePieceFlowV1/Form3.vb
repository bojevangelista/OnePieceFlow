        ...
        If Asc(e.KeyChar) = 13 Then
            ...
            Using reader As SqlDataReader = Activecmd.ExecuteReader()
                If reader.HasRows Then
                    While reader.Read()
                        If Label15.Text = reader.Item("SomtrackID") And reader.Item("Status") = 4 Then
                            con2.Close()
                            GoTo Accept
...
StopEntry:
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Using reader As SqlDataReader = TableCaseQuery.ExecuteReader()
            If reader.HasRows Then
                While reader.Read()
                    ListBox2.Items.Add(reader.Item("SomtrackID").ToString)
                End While
